...
#define DEF_CFG_DISK_SEC_SIZE      512                                                 /* ����������С */
//#define DEF_FLASH_SECTOR_SIZE      512                                                 /* ����FLASH������С */
#define DEF_UDISK_SECTOR_SIZE      DEF_CFG_DISK_SEC_SIZE                               /* ����U��������С */
...
extern volatile uint8_t  Udisk_Attention;     /* UNIT ATTENTION (media changed) latch */
